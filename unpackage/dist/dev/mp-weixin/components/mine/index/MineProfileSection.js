...
const _sfc_main = {
  ...
  methods: {
    ...
    handleOrderItemClick(item) {
      common_vendor.index.__f__("log", "at components/mine/index/MineProfileSection.vue:141", "Order item clicked:", item);
    ...
    handleAssetItemClick(item) {
      common_vendor.index.__f__("log", "at components/mine/index/MineProfileSection.vue:148", "Asset item clicked:", item);
      if (item.label === "优惠券") {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-18e3cb5c"]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/components/mine/index/MineProfileSection.js.map
