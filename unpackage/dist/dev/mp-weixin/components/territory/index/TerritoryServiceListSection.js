...
const _sfc_main = {
  ...
  methods: {
    handleMore() {
      common_vendor.index.__f__("log", "at components/territory/index/TerritoryServiceListSection.vue:121", "More clicked");
    },
    handlePromote() {
      common_vendor.index.__f__("log", "at components/territory/index/TerritoryServiceListSection.vue:124", "Promote clicked");
    },
    handleBookAgain() {
      common_vendor.index.__f__("log", "at components/territory/index/TerritoryServiceListSection.vue:127", "Book again clicked");
    }
  }
};
