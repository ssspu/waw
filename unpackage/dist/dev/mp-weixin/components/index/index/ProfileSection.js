...
const _sfc_main = {
  ...
  methods: {
    handleQuickAction(action, index) {
      ...
      if (url) {
        common_vendor.index.__f__("log", "at components/index/index/ProfileSection.vue:428", "准备跳转到:", url);
        common_vendor.index.navigateTo({
          url,
          success: (res) => {
            common_vendor.index.__f__("log", "at components/index/index/ProfileSection.vue:432", "跳转成功:", res);
          },
          fail: (err) => {
            common_vendor.index.__f__("error", "at components/index/index/ProfileSection.vue:435", "跳转失败:", err);
    ...
    handleSectionHeaderClick(section) {
      ...
      if (url) {
        common_vendor.index.__f__("log", "at components/index/index/ProfileSection.vue:457", "准备跳转到:", url);
        common_vendor.index.navigateTo({
          url,
          success: (res) => {
            common_vendor.index.__f__("log", "at components/index/index/ProfileSection.vue:461", "跳转成功:", res);
          },
          fail: (err) => {
            common_vendor.index.__f__("error", "at components/index/index/ProfileSection.vue:464", "跳转失败:", err);
            common_vendor.index.showToast({
              title: "跳转失败: " + (err.errMsg || "未知错误"),
              icon: "none",
              duration: 2e3
