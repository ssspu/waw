...
const _sfc_main = {
  ...
  methods: {
    switchNav(index) {
      common_vendor.index.__f__("log", "at components/designer/detail/DesignerPortfolioSection.vue:169", "Switch nav:", index);
    },
    selectTag(index) {
    ...
    handleViewMoreReviews() {
      common_vendor.index.__f__("log", "at components/designer/detail/DesignerPortfolioSection.vue:177", "View more reviews");
    },
    handleViewMoreQA() {
      common_vendor.index.__f__("log", "at components/designer/detail/DesignerPortfolioSection.vue:180", "View more QA");
    },
    handleQuestionClick(question) {
      common_vendor.index.__f__("log", "at components/designer/detail/DesignerPortfolioSection.vue:183", "Question clicked:", question);
    },
    handleJoin() {
      common_vendor.index.__f__("log", "at components/designer/detail/DesignerPortfolioSection.vue:186", "Join clicked");
    }
  }
};
