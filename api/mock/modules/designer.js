...
const designers = [
  ...
  },
  {
    ...
    position: '创意总监',
    experience: 15,
    introduction: '国际沙宣学院认证导师，擅长欧美系造型设计。',
    specialties: ['创意剪裁', '欧美造型', '高端染发'],
    rating: 4.9,
    reviewCount: 512,
    serviceCount: 3200,
    worksCount: 280,
  ...
  },
  {
    ...
    position: '资深设计师',
    experience: 7,
    introduction: '日韩系造型专家，擅长氛围感发型设计。',
    specialties: ['日韩造型', '氛围感设计', '柔顺护理'],
    rating: 4.8,
    reviewCount: 267,
    serviceCount: 1890,
    worksCount: 145,
  ...
  },
  {
    ...
    position: '造型师',
    experience: 5,
    introduction: '新锐造型师，擅长时尚短发和个性造型。',
    specialties: ['时尚短发', '个性造型', '轻盈剪裁'],
    rating: 4.6,
    reviewCount: 156,
    serviceCount: 876,
    worksCount: 89,
...
const designerServices = [
  // 美发服务
  { id: '1', designerId: '1', serviceType: 'hair-service', category: 'perm', name: '烫发', description: '发型提案+烫发+造型', price: 799, originalPrice: 999, duration: 60, soldCount: 1234, discount: '预约优惠10%', image: 'https://c.animaapp.com/mi5d4lp0csJxnR/img/rectangle-169-3.png' },
  { id: '2', designerId: '1', serviceType: 'hair-service', category: 'wash-cut-blow', name: '精致剪发', description: '专业剪发+造型设计', price: 99, originalPrice: 128, duration: 45, soldCount: 2356, discount: '新客立减20', image: 'https://c.animaapp.com/mi5d4lp0csJxnR/img/rectangle-169-3.png' },
  ...
  { id: '5', designerId: '2', serviceType: 'hair-service', category: 'perm', name: '韩式烫发', description: '韩式造型+烫发+护理', price: 899, originalPrice: 1199, duration: 120, soldCount: 956, discount: '预约优惠10%', image: 'https://c.animaapp.com/mi5d4lp0csJxnR/img/rectangle-169-3.png' },
  { id: '6', designerId: '2', serviceType: 'hair-service', category: 'wash-cut-blow', name: '总监剪发', description: '总监亲剪+造型设计', price: 199, originalPrice: 258, duration: 60, soldCount: 1890, discount: '新客立减30', image: 'https://c.animaapp.com/mi5d4lp0csJxnR/img/rectangle-169-3.png' },
  { id: '7', designerId: '3', serviceType: 'hair-service', category: 'wash-cut-blow', name: '男士造型', description: '男士专业剪发+造型', price: 79, originalPrice: 99, duration: 30, soldCount: 3200, discount: '新客立减10', image: 'https://c.animaapp.com/mi5d4lp0csJxnR/img/rectangle-169-3.png' },
  ...
  { id: '9', designerId: '4', serviceType: 'hair-service', category: 'perm', name: '女士烫发', description: '女士专属烫发造型', price: 699, originalPrice: 899, duration: 90, soldCount: 1456, discount: '预约优惠10%', image: 'https://c.animaapp.com/mi5d4lp0csJxnR/img/rectangle-169-3.png' },
  ...
  // 其他服务 - 仅设计师1有
  { id: '14', designerId: '1', serviceType: 'other-service', category: 'consultation', name: '形象咨询', description: '一对一形象设计咨询', price: 199, originalPrice: 299, duration: 30, soldCount: 123, discount: '', image: 'https://c.animaapp.com/mi5d4lp0csJxnR/img/rectangle-169-3.png' },
  // 设计师2的更多服务
  ...
  // 设计师3的更多服务
  { id: '17', designerId: '3', serviceType: 'hair-service', category: 'perm', name: '男士纹理烫', description: '自然纹理烫发造型', price: 499, originalPrice: 699, duration: 60, soldCount: 456, discount: '新客立减50', image: 'https://c.animaapp.com/mi5d4lp0csJxnR/img/rectangle-169-3.png' },
  ...
  // 设计师4的更多服务
  { id: '19', designerId: '4', serviceType: 'hair-service', category: 'wash-cut-blow', name: '女士精剪', description: '女士专业剪发造型', price: 128, originalPrice: 168, duration: 45, soldCount: 789, discount: '新客立减20', image: 'https://c.animaapp.com/mi5d4lp0csJxnR/img/rectangle-169-3.png' },
  ...
  { id: '21', designerId: '4', serviceType: 'hair-service', category: 'care', name: '柔顺护理', description: '深层柔顺修复护理', price: 299, originalPrice: 399, duration: 60, soldCount: 345, discount: '会员专享', image: 'https://c.animaapp.com/mi5d4lp0csJxnR/img/rectangle-169-3.png' },
  // 设计师5的更多服务
  ...
  { id: '25', designerId: '6', serviceType: 'hair-service', category: 'wash-cut-blow', name: '氛围感剪发', description: '日系氛围感造型', price: 128, originalPrice: 168, duration: 45, soldCount: 567, discount: '新客立减20', image: 'https://c.animaapp.com/mi5d4lp0csJxnR/img/rectangle-169-3.png' },
  ...
  { id: '29', designerId: '7', serviceType: 'hair-service', category: 'wash-cut-blow', name: '时尚剪发', description: '潮流时尚剪发造型', price: 99, originalPrice: 128, duration: 45, soldCount: 456, discount: '新客立减10', image: 'https://c.animaapp.com/mi5d4lp0csJxnR/img/rectangle-169-3.png' },
  { id: '30', designerId: '7', serviceType: 'hair-service', category: 'perm', name: '挑染烫发', description: '挑染+烫发造型', price: 899, originalPrice: 1199, duration: 150, soldCount: 345, discount: '预约优惠20%', image: 'https://c.animaapp.com/mi5d4lp0csJxnR/img/rectangle-169-3.png' },
  ...
  { id: '33', designerId: '8', serviceType: 'hair-service', category: 'perm', name: '个性烫发', description: '个性造型烫发', price: 599, originalPrice: 799, duration: 90, soldCount: 345, discount: '预约优惠10%', image: 'https://c.animaapp.com/mi5d4lp0csJxnR/img/rectangle-169-3.png' },
...
const designerWorks = [
  // 设计师1的作品
  { id: '1', designerId: '1', type: 'female', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '女士短发造型', description: '清爽短发，展现独特气质', likes: 236, time: '2025-11-20' },
  { id: '2', designerId: '1', type: 'female', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '时尚渐变染发', description: '个性渐变色，潮流前沿', likes: 189, time: '2025-11-18' },
  ...
  { id: '4', designerId: '1', type: 'male', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '男士商务造型', description: '干练利落，商务精英', likes: 98, time: '2025-11-12' },
  { id: '5', designerId: '1', type: 'male', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '男士潮流短发', description: '潮流前卫，个性十足', likes: 145, time: '2025-11-10' },
  { id: '6', designerId: '1', type: 'kids', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '儿童可爱造型', description: '活泼可爱，童趣满满', likes: 78, time: '2025-11-08' },
  // 设计师2的作品
  ...
  { id: '8', designerId: '2', type: 'female', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '优雅长发造型', description: '飘逸长发，气质优雅', likes: 234, time: '2025-11-10' },
  { id: '9', designerId: '2', type: 'female', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '韩式烫发造型', description: '韩式自然卷，温柔可人', likes: 189, time: '2025-11-09' },
  ...
  { id: '11', designerId: '2', type: 'male', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '男士商务短发', description: '干练专业，商务首选', likes: 145, time: '2025-11-06' },
  { id: '12', designerId: '2', type: 'kids', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '儿童时尚造型', description: '时尚可爱，萌趣十足', likes: 89, time: '2025-11-05' },
  // 设计师3的作品
  ...
  { id: '15', designerId: '3', type: 'male', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '潮流短发造型', description: '潮流前卫，个性张扬', likes: 267, time: '2025-11-10' },
  { id: '16', designerId: '3', type: 'female', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '中性风短发', description: '帅气中性，酷感十足', likes: 156, time: '2025-11-08' },
  { id: '17', designerId: '3', type: 'female', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '渐变染发造型', description: '个性渐变，独特魅力', likes: 189, time: '2025-11-06' },
  ...
  { id: '21', designerId: '4', type: 'female', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '女神长发造型', description: '飘逸长发，女神气质', likes: 256, time: '2025-11-14' },
  { id: '22', designerId: '4', type: 'male', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '男士简约造型', description: '简约干净，清爽帅气', likes: 134, time: '2025-11-12' },
  { id: '23', designerId: '4', type: 'male', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '绅士分头造型', description: '绅士风范，成熟稳重', likes: 112, time: '2025-11-10' },
  { id: '24', designerId: '4', type: 'kids', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '女孩公主造型', description: '甜美公主，可爱动人', likes: 89, time: '2025-11-08' },
  // 设计师5的作品
  { id: '25', designerId: '5', type: 'female', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '欧美系大波浪', description: '欧美风格，性感迷人', likes: 456, time: '2025-11-20' },
  ...
  { id: '27', designerId: '5', type: 'female', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '创意剪裁造型', description: '创意设计，独特风格', likes: 345, time: '2025-11-16' },
  { id: '28', designerId: '5', type: 'male', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '高端男士造型', description: '精致剪裁，高端品质', likes: 267, time: '2025-11-14' },
  ...
  { id: '30', designerId: '5', type: 'kids', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '精致儿童造型', description: '精致可爱，萌化人心', likes: 123, time: '2025-11-10' },
  // 设计师6的作品
  { id: '31', designerId: '6', type: 'female', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '日系慵懒卷', description: '日系慵懒，氛围感满分', likes: 289, time: '2025-11-19' },
  ...
  { id: '35', designerId: '6', type: 'male', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '韩系男士造型', description: '韩系温柔，暖男气质', likes: 156, time: '2025-11-11' },
  ...
  // 设计师7的作品
  { id: '37', designerId: '7', type: 'female', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '潮流挑染造型', description: '潮流挑染，个性前卫', likes: 312, time: '2025-11-20' },
  ...
  // 设计师8的作品
  { id: '43', designerId: '8', type: 'female', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '时尚短发造型', description: '时尚短发，干练帅气', likes: 234, time: '2025-11-19' },
  ...
  { id: '45', designerId: '8', type: 'female', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '轻盈短发造型', description: '轻盈蓬松，青春活力', likes: 178, time: '2025-11-15' },
  { id: '46', designerId: '8', type: 'male', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '清爽男士短发', description: '清爽干净，阳光帅气', likes: 156, time: '2025-11-13' },
  { id: '47', designerId: '8', type: 'male', image: 'https://c.animaapp.com/mi5jretszAhz9Y/img/rectangle-173.png', title: '个性男士造型', description: '个性张扬，潮流前卫', likes: 134, time: '2025-11-11' },
...
const ratingStats = {
  '1': {
    ...
    filterTags: [
      ...
      { label: '服务态度', count: 156, filter: 'service' }
    ]
  },
  '2': {
    overall: 4.9,
    ...
    filterTags: [
      { label: '全部', count: null, filter: 'all' },
      { label: '技术很好', count: 289, filter: 'skill' },
      { label: '效果满意', count: 267, filter: 'effect' },
      { label: '服务态度', count: 198, filter: 'service' }
    ]
  },
  '3': {
    overall: 4.7,
    ...
    filterTags: [
      { label: '全部', count: null, filter: 'all' },
      { label: '技术很好', count: 198, filter: 'skill' },
      { label: '效果满意', count: 178, filter: 'effect' },
      { label: '服务态度', count: 134, filter: 'service' }
    ]
  },
  '4': {
    overall: 4.8,
    ...
    filterTags: [
      { label: '全部', count: null, filter: 'all' },
      { label: '技术很好', count: 156, filter: 'skill' },
      { label: '效果满意', count: 145, filter: 'effect' },
      { label: '服务态度', count: 123, filter: 'service' }
    ]
  },
  '5': {
    overall: 4.9,
    ...
    filterTags: [
      { label: '全部', count: null, filter: 'all' },
      { label: '技术很好', count: 423, filter: 'skill' },
      { label: '效果满意', count: 389, filter: 'effect' },
      { label: '服务态度', count: 278, filter: 'service' }
    ]
  },
  '6': {
    overall: 4.8,
    ...
    filterTags: [
      { label: '全部', count: null, filter: 'all' },
      { label: '技术很好', count: 213, filter: 'skill' },
      { label: '效果满意', count: 198, filter: 'effect' },
      { label: '服务态度', count: 167, filter: 'service' }
    ]
  },
  '7': {
    overall: 4.7,
    ...
    filterTags: [
      { label: '全部', count: null, filter: 'all' },
      { label: '技术很好', count: 145, filter: 'skill' },
      { label: '效果满意', count: 134, filter: 'effect' },
      { label: '服务态度', count: 98, filter: 'service' }
    ]
  },
  '8': {
    overall: 4.6,
    ...
    filterTags: [
      { label: '全部', count: null, filter: 'all' },
      { label: '技术很好', count: 112, filter: 'skill' },
      { label: '效果满意', count: 98, filter: 'effect' },
      { label: '服务态度', count: 78, filter: 'service' }
    ]
  }
}
