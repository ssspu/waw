...
const brands = [
  {
    id: '1',
    name: '金龙大好人美发沙龙',
    avatar: 'https://c.animaapp.com/mi5cgxi6ndVkfo/img/rectangle-220-2.png',
    coverImage: 'https://c.animaapp.com/mi5cgxi6ndVkfo/img/rectangle-220-2.png',
    badge: '舒适',
    certification: '企业认证',
    nature: '专业店',
    type: '专业美发店',
    mainServices: '剪发、烫发、染发、护发',
    businessDays: '周一 - 周日',
  ...
  },
  {
    id: '2',
    name: '成都NICE造型沙龙',
    avatar: 'https://c.animaapp.com/mi5cgxi6ndVkfo/img/rectangle-220-3.png',
    coverImage: 'https://c.animaapp.com/mi5cgxi6ndVkfo/img/rectangle-220-3.png',
    badge: '精品',
    certification: '企业认证',
    nature: '连锁品牌',
    type: '连锁美发品牌',
    mainServices: '造型设计、烫染护理',
    businessDays: '周一 - 周日',
  ...
  },
  {
    id: '3',
    name: '潮流发型工作室',
    avatar: 'https://c.animaapp.com/mi5cgxi6ndVkfo/img/rectangle-220-4.png',
    coverImage: 'https://c.animaapp.com/mi5cgxi6ndVkfo/img/rectangle-220-4.png',
    badge: '潮流',
    certification: '个人认证',
    nature: '工作室',
    type: '潮流工作室',
    mainServices: '潮流造型、个性染发',
    businessDays: '周三 - 周日',
    establishedYear: 2019,
    introduction: '专注潮流发型设计，为年轻人打造个性造型。',
    rating: 4.7,
    reviewCount: 876,
    designerCount: 5,
    serviceCount: 18,
  ...
  },
  {
    id: '4',
    name: '优雅女士美发馆',
    avatar: 'https://c.animaapp.com/mi5cgxi6ndVkfo/img/rectangle-220-5.png',
    coverImage: 'https://c.animaapp.com/mi5cgxi6ndVkfo/img/rectangle-220-5.png',
    badge: '优雅',
    certification: '企业认证',
    nature: '专业店',
    type: '女士专属美发',
    mainServices: '女士造型、护发养护',
    businessDays: '周一 - 周日',
  ...
  },
  {
    ...
    nature: '专业店',
    type: '男士专属理发',
    mainServices: '男士剪发、修面刮胡',
    businessDays: '周一 - 周日',
    establishedYear: 2018,
    introduction: '专业男士理发服务，快速高效，打造精神帅气形象。',
    rating: 4.6,
    reviewCount: 987,
    designerCount: 8,
    serviceCount: 15,
  ...
  },
  {
    ...
    certification: '企业认证',
    nature: '连锁品牌',
    introduction: '正宗韩式美发技术，打造韩剧同款造型。',
    rating: 4.9,
    reviewCount: 1876,
    designerCount: 10,
    serviceCount: 28,
  ...
  },
  {
    ...
    certification: '个人认证',
    nature: '工作室',
    introduction: '创意发型设计，每一款都是独一无二的艺术品。',
    rating: 4.7,
    reviewCount: 654,
    designerCount: 4,
    serviceCount: 12,
  ...
  },
  {
    ...
    certification: '企业认证',
    nature: '高端会所',
    introduction: '高端私密美发会所，一对一专属服务，尊贵体验。',
    rating: 4.9,
    reviewCount: 567,
    designerCount: 6,
    serviceCount: 20,
